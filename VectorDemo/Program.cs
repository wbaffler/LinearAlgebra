...
namespace VectorDemo
{
    class Program
    {
        ...
        private static MathVector MakeVector(double[] array)
        {
        ...
        static void Main(string[] args)
        {
            ...
            MathVector vec1 = MakeVector(new double [] { 0 , 1});
            //Console.WriteLine(vec1[1]);

            MathVector[] v = new MathVector[3];
            v[0] = MakeVector(new double[] { 0, 2 });



            //var vec2 = vec1 + 5;
            Console.WriteLine(v[0][1]);
            //Console.WriteLine(vec2[1]);
            //var vec3 = vec1 / 0;
            //Console.WriteLine(vec3[1]);
            //var vec4 = new MathVector(-5);
